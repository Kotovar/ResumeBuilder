...
const en: Translations = {
  ...
  summary: {
    ...
    placeholder: 'Experienced engineer with 5+ years building scalable systems…',
  },
  experience: {
    ...
    phDescription: 'Tools used, team context, or any other relevant details…',
...
const ru: Translations = {
  ...
  summary: {
    ...
    placeholder: 'Опытный разработчик с 5+ годами опыта создания масштабируемых систем…',
  },
  experience: {
    ...
    phDescription: 'Используемые инструменты, контекст или любые другие детали…',
