  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden bg-white">
      ...
      >
        ...
        <button
          type="button"
          onClick={(e) => { e.stopPropagation(); removeProject(entry.id); }}
      ...
      {open && (
        <div className="px-3 pb-4 pt-2 flex flex-col gap-3 border-t border-gray-100">
          <div className="grid grid-cols-2 gap-3">
            ...
            <FormField label={t.url}    value={entry.url}    onChange={(v) => upd({ url: v })}    placeholder="myproject.com" />
            <FormField label={t.github} value={entry.github} onChange={(v) => upd({ github: v })} placeholder="github.com/you/repo" />
          </div>
