...
import type { ExperienceEntry } from "@type/resume";
...
function ExperienceCard({ entry, index }: Props) {
    const {
        experience,
        updateExperience,
        removeExperience,
    ...
    const upd = (data: Partial<ExperienceEntry>) =>
        updateExperience(entry.id, data);
