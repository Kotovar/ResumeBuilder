...
import type { SectionId } from "@type/resume";
...
export function SectionNav({ active, onSelect }: Props) {
    const { sections, toggleSectionVisibility, reorderSections } =
        useResumeStore();
    const t = useT();
    ...
    const handleToggleVisibility = (e: MouseEvent, sectionId: SectionId) => {
        e.stopPropagation();
                  ...
                  isActive
                    ...
                    >
                        ...
                        >
                            <button
                                disabled={i === 0}
                                onClick={(e) => handleReorder(e, i, i - 1)}
                                title="Move up"
