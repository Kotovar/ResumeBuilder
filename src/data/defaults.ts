...
export function createDefaultResume(): ResumeData {
  return {
    ...
    experience: [
      {
        ...
        endDate:     '',
        current:     true,
        description: 'Led a 6-person team responsible for the core platform. Owned the full-stack architecture across billing, authentication, and third-party integrations.',
        highlights: [
    ...
    skills: [
      { id: crypto.randomUUID(), category: 'Languages',      skills: ['TypeScript', 'Python', 'Go', 'SQL'] },
      { id: crypto.randomUUID(), category: 'Frontend',       skills: ['React', 'Next.js', 'TailwindCSS', 'GraphQL'] },
      { id: crypto.randomUUID(), category: 'Backend & Cloud', skills: ['Node.js', 'PostgreSQL', 'Redis', 'AWS', 'Docker'] },
    ],
    projects: [
      {
        id:           crypto.randomUUID(),
